...
export const typePin = tv({
  base: "shadowForLight flex justify-center items-baseline capitalize gap-2 py-1.5 pt-2.5 px-2.5 min-w-[6.25rem] rounded-md font-semibold before:inline-block before:w-2 before:h-2 sm:text-sm",
  variants: {
    type: {
